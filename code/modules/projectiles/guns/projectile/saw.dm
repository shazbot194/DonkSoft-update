...
/obj/item/weapon/gun/projectile/automatic/l6_saw/update_icon()
	icon_state = "l6[item_color][cover_open ? "open" : "closed"][magazine ? Ceiling(get_ammo(0)/12.5)*25 : "-empty"][suppressed ? "-suppressed" : ""]"
	item_state = "l6[item_color][cover_open ? "openmag" : "closedmag"]"
