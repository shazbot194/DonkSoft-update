...
/obj/item/weapon/gun/energy/laser/cyborg/lesser
	name = "Small laser"
...
/obj/item/weapon/gun/energy/laser/cyborg/metalfoam
	name = "Foam launcher"
	desc = "A small grenade launcher meant to seal up hull breaches"
